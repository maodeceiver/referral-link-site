...
export const sites: Site[] = [
  ...
  },
  {
    ...
    nameSuffix: '.gold',
    tone: 'gold',
    logo: '/logos/caser.webp',
    tagline: 'WEEKLY BONUS',
    kind: 'Еженедельный бонус',
    bonusHighlight: 'Бонус каждую неделю',
    bonusRest: 'на баланс аккаунта',
    promo: '',
    rating: 4.72,
    reviews: 918,
    categories: ['free', 'cases', 'upgrade'],
    url: 'https://caser.gold',
    checked: 'сегодня',
    perks: [
      'Еженедельный бонус на баланс',
      'Кейсы и апгрейдер скинов',
      'Вывод предметов в инвентарь Steam',
    ],
    minDeposit: 'не нужен',
    payouts: 'Steam-трейд',
  },
  {
    ...
    nameSuffix: 'Strike',
    tone: 'sky',
    logo: '/logos/tastystrike.webp',
    tagline: 'OPEN & WIN',
    kind: 'Бонус за регистрацию',
    bonusHighlight: 'Бесплатный кейс',
    bonusRest: 'сразу после регистрации',
    promo: '',
    rating: 4.68,
    reviews: 806,
    categories: ['free', 'cases', 'upgrade'],
    url: 'https://tastystrike.vip/',
    checked: 'сегодня',
    perks: [
      'Бесплатный кейс без пополнения счёта',
      'Вход через Steam за пару секунд',
      'Вывод выигранных скинов в инвентарь',
    ],
    minDeposit: 'не нужен',
    payouts: 'Steam-трейд',
  },
  ...
  },
  {
    ...
    checked: 'сегодня',
    perks: [
      'Промокод CodeCase активируется в профиле',
